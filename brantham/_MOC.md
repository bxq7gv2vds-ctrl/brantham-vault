...
- [[brantham/knowledge/finance/assurances-ma-distressed]] — Assurances en M&A distressed: D&O (couverture, run-off, marche), RC pro AJ/MJ, alternatives garantie passif (escrow/retention/earn-out), W&I insurance (disponibilite limitee distressed, cout 2-5%), assurance homme-cle, PLL risque environnemental (BASOL/BASIAS/SIS), checklist assurances par phase de deal
- [[brantham/knowledge/finance/pi-actifs-incorporels-distressed]] — PI et actifs incorporels en M&A distressed: valorisation marques (royalty relief, couts, comparables), brevets (annuites INPI, FTO), cession PI en procedure (L642-18+, INPI/EUIPO), franchise (intuitu personae, L622-13), logiciel/SaaS (escrow, licences, code source), noms de domaine (SEO), donnees clients (RGPD), CIR/CII, checklist PI repreneur
